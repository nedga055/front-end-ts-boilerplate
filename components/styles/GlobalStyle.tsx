			...
			styles={css`
				...
				@font-face {
					...
					src: local("Raleway Light Italic"), local("Raleway-LightItalic"),
						url("./static/fonts/raleway/Raleway-LightItalic.woff2")
							format("woff2");
				...
				@font-face {
					...
					src: local("Raleway Bold Italic"), local("Raleway-BoldItalic"),
						url("./static/fonts/raleway/Raleway-BoldItalic.woff2")
							format("woff2");
					unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6,
						U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193,
						U+2212, U+2215, U+FEFF, U+FFFD;
				...
				@font-face {
					...
					src: local("Raleway Light"), local("Raleway-Light"),
						url("./static/fonts/raleway/Raleway-Light.woff2") format("woff2");
					unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6,
						U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193,
						U+2212, U+2215, U+FEFF, U+FFFD;
				}
				...
				*:after {
				...
				body {
					background: ${theme.colors.gray.w100};
					color: ${theme.colors.gray.w900};
					font-size: 1.8rem;
					line-height: 2;
					margin: 0;
					padding: 0;
				...
				/* To override theme.min.css (WET) */
				[placeholder]:not(.wb-srch-q),
				input[placeholder]:not(.wb-srch-q) {
